...
async def get_playlist_by_id(playlist_id: int):
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail="Internal server error with get playlists by id",
...
async def create_playlist(request: Request, playlist: MusibaraPlaylistType, file: UploadFile):
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail="Internal server error with creating playlists",
            headers={"WWW-Authenticate": "Bearer"},
        )
    finally:
        if cursor:
...
async def get_playlists_by_userid(user_id: int):
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail="Internal server error with getting playlists by userid",
            headers={"WWW-Authenticate": "Bearer"},
        )
    finally:
        if cursor:
...
async def get_user_playlists(request: Request):
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail="Internal server error with getting user's playlists",
            headers={"WWW-Authenticate": "Bearer"},
        )
    finally:
        if cursor:
...
async def get_herd_playlists(herd_id: int):
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail="Internal server error with getting herd's playlists",
            headers={"WWW-Authenticate": "Bearer"},
        )
    finally:
        if cursor:
...
def import_playlist(user, import_request: PlaylistImportRequest):
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail="Internal server error with importing playlists",
            headers={"WWW-Authenticate": "Bearer"},
        )
    finally:
        if cursor:
